...
city_set = ["Boston%2C+ma","Worcester%2C+ma"]#, "Concord%2C+nh","Portsmouth%2C+nh","Nashua%2C+nh","Manchester%2C+nh","Portland%2C+or","Seattle%2C+wa","Denver%2C+co","Hartford%2C+ct","New+Haven%2C+ct","Providence%2C+ri","Portland%2C+me"]

#job titles
job_title_set = ["mechanical+engineer","product+engineer","mechanical+design+engineer","design+engineer","engineer", "automation+engineer", "automations+engineer"]
